...
Source0  : https://github.com/Oblomov/clinfo/archive/3.0.21.02.21/clinfo-3.0.21.02.21.tar.gz
...
%prep
%setup -q -n clinfo-3.0.21.02.21
cd %{_builddir}/clinfo-3.0.21.02.21
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1614008313
...
cp %{_builddir}/clinfo-3.0.21.02.21/LICENSE %{buildroot}/usr/share/package-licenses/clinfo/5447aca2f62e3ba417ad9ba64f6567d7fbac8ace
%make_install
